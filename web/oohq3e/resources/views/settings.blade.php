...
@section('content')
        ...
        <div class="">
            <div class="p-3 lg:max-w-2/3 md:max-w-10/12 sm:max-w-11/12 flex flex-wrap justify-center">
                        ...
                        <div class="bg-gray-100 rounded-lg overflow-auto m-3 bg-opacity-90">
                            ...
                            <div class="flex flex-wrap gap-2 justify-center m-5">
                                <a href="/device/{{ asset('create') }}">
                                    <div class="my-1 bg-green-500 text-white uppercase rounded-full py-3 px-6 transition hover:bg-green-400 hover:text-white w-48 text-center">
                                        Add device
                                    </div>
                                </a>
                                <a href="/settings/{{ $room -> id }}/edit">
                                    <div class="my-1 bg-yellow-500 text-white uppercase rounded-full py-3 px-6 transition hover:bg-yellow-400 hover:text-white w-48 text-center">
                                        Modify room
                                    </div>
                                </a>
                                <form action="/delete" method="POST">
                                    @csrf<button class="uppercase my-1 uppercase bg-red-500 text-white rounded-full py-3 px-6 transition hover:bg-red-400 hover:text-white w-48 text-center" name="id" type="submit" value="{{ $room -> id }}">Delete room</button>
                                </form>
                            </div>
