...
\begin{document}
	...
	Pédlául \aref{return-room}.~programkódban, ahol egy szobát adunk vissza a módosítás nézetbe, és annak szobának a nevét így érhetjük el: \emph{\textbf{,,\{\{\$room->name\}\}''}}
