...
\begin{document}
	...
	Hogy ha törölni szeretnénk szobát vagy eszközt, akkor legelőször is megkérdezi a felhasználót az oldal egy értesítésben, hogy biztos-e abban, hogy törölni akarja az adott rekordot. Mindezt \aref{database}.~szakaszban leírom, hogy miért is nagy döntés, hogy törölne a felhasználó egy szobát vagy eszközt.
